...
public class UjMegrendelesDialogNew extends javax.swing.JDialog {
    ...
    public UjMegrendelesDialogNew(java.awt.Frame parent, boolean modal) {
        ...
        try {
            ...
            dolgozo =new DolgozoRepositoryJDBC().findById(User.id);
    ...
    private void btnRogzitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRogzitActionPerformed
        ...
        int retValue = JOptionPane.showOptionDialog(this, "Biztos, hogy rögzíti a kimenő megrendelést?", "", JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, options,null);
